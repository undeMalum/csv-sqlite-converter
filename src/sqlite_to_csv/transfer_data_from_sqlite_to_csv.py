...
from src.context_managers.csv_managers import CSVWriter
from src.sqlite_to_csv.files_paths import GENERATED_CSVS_DIR_PATH
...
def create_csv_files_dir(database_path: Path):
    csv_files_dir = GENERATED_CSVS_DIR_PATH.joinpath(database_path.stem)
...
def import_sqlite_to_csv(database_path: Path, table: str) -> None:
    ...
    csv_files_dir = create_csv_files_dir(database_path)
